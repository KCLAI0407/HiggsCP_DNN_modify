...
def read_raw_all(args, letters):
    ...
    for i,letter in enumerate(letters):
        name = os.path.join(data_path, "pythia.Z_115_135.a1rho.1M.%s.outTUPLE_labFrame" % (letter))
        print letter, name
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input", dest="IN", default='HiggsCP_data/a1rho')
    ...
    np.save(os.path.join(data_path, "a1rhoZ_raw.data.npy"), data)
